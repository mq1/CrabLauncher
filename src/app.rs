...
impl eframe::App for App {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::TopBottomPanel::top("navbar").exact_height(48.).frame(navbar_frame).show(ctx, |ui| {
            ...
            ui.horizontal_centered(|ui| {
                ...
                if self.page == Page::Instances {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Min), |ui| {
                        if ui.add(navigation_button(egui::include_image!("../assets/mdi/information-outline.svg"))).clicked() {
                            about_modal.open();
                        }

                        if ui.add(navigation_button(egui::include_image!("../assets/mdi/cog-outline.svg"))).clicked() {
                            settings_modal.open();
                        }
                    });
                } else {
